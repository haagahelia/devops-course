    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/haagahelia/devops-course',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Study guide',
                href: 'https://opinto-opas.haaga-helia.fi/course_unit/SOF018AS3A',
              },
              {
                label: 'Discord',
